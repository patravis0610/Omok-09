...
{
    public const string ServerURL = "http://192.168.0.11:3000";
    public const string SocketServerURL = "ws://192.168.0.11:3000";
    ...
    public enum PlayerType { None, Player_Black, Player_White }
